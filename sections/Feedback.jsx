    ...
    <motion.div
      ...
      >
        ...
        border-[#6a6a6a] relative">
          <div className="feedback-gradient"/>
            <div>
              ...
              leading-[36px] text-white">Samantha</h4>
            ...
            “With the development of today's technology,
             ...
             can be called web 3.0. by using metaverse 
        ...
        className='lg:block hidden absolute -left-[10%] top-[3%]'>
          {/* its absolute so that we can position it on top of the image */}
            <img
              src='/stamp.png'
              alt="stamp"
              className="w-[100px] h-[155px] object-contain"
            />
